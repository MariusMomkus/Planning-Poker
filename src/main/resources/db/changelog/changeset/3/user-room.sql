...
CREATE TABLE `user-room` (
  ...
  CONSTRAINT `FKojiggkyu5eume7rcqkh6j6mg3` FOREIGN KEY (`room_id`) REFERENCES `room` (`room_id`),
...
INSERT INTO `user-room` VALUES (28,28,7,1),(29,29,2,1),(30,30,1,1),(31,31,7,1),(32,32,7,1);
...
-- Dump completed on 2023-03-31 14:16:16
